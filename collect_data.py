...
logging.basicConfig(filename='collect_data.log', encoding='utf-8',
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--commit_data_dir", type=str, default="extracted_data_csv", help="path to directory to save collected commit data"
    )

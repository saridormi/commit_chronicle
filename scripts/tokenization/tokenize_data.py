...
def main(cfg: DictConfig) -> None:
    cfg.training_processor.diff_tokenizer_name_or_path = to_absolute_path(cfg.training_processor.diff_tokenizer_name_or_path)
    ...
    for part in ["train", "val", "test", "val_original", "test_original"]:
        processor(input_filename=os.path.join(cfg.paths.input_root_dir, f"{part}_final.csv"),
